...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://uet3ogk4d2.execute-api.us-east-1.amazonaws.com/stage_v1';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['q'], ['body']);//'q'
    ...
    apigClient.uploadBucketObjectPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['object', 'Content-Type', 'realcontenttype','bucket'], ['body']);
        ...
        console.log(uploadBucketObjectPutRequest)
